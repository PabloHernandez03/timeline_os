...
const PedidosView: React.FC = () => {
  ...
  return (
    <div>
        <div className="flex justify-items-center items-center mb-10 px-10 py-8 rounded-xl border-2 border-white-900">
          <video
            src={resources[1].src}
            className="w-1/5 rounded-lg shadow-lg border-2 border-white-900"
            autoPlay
            loop
            muted
          />
            ...
            <img
              src={resources[0].src}
              alt="Pedido 1"
              className="w-3/4 rounded-lg shadow-lg border-2 border-white-900" 
            />
            </div>
          <video
            src={resources[2].src}
        ...
        <div className="flex justify-items-center items-center mb-10 px-10 py-8 rounded-xl border-2 border-white-900">
            <div className="flex justify-center items-center w-full">
              <img
                src={resources[7].src}
                alt="Pedido 3"
                className="w-10/12 rounded-lg shadow-lg border-2 border-white-900"
              />
            </div>
          <video
              src={resources[6].src}
        ...
        <div className="flex justify-around items-center mb-10 px-10 py-8 rounded-xl border-2 border-white-900">
          <video
              src={resources[9].src}
              className="w-1/5 rounded-lg shadow-lg border-2 border-white-900"
              autoPlay
